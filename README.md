...
Small, validated football schedule feed for the WhoseIPTV Android app. No domain or server is required.

## Public feed

`https://raw.githubusercontent.com/craetsodom-hub/whoseiptv/main/feed/events/v1/events.json`

The scheduled GitHub Action refreshes the feed every three hours. It currently requests today plus the next two UTC days for broadcaster territories GB, US, ES, FR, and MA.
...
- Only records containing a football event, valid UTC time, territory, and named broadcaster are published.
